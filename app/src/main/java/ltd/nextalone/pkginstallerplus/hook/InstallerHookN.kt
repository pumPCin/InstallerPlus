    ...
    private fun replaceSpacerWithInfoView(spacer: View, activity: Activity) {
        ...
        if (oldPkgInfo == null) {
            ...
            sb.append(activity.getString(R.string.IPP_info_user) + ": ")
                ...
                .append(pkgName, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
                .append('\n')
                .append(activity.getString(R.string.IPP_info_version) + ": ")
                .append(newVersionStr, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
                .append('\n')
                .append(activity.getString(R.string.IPP_info_sdk) + ": ")
                .append(newSdkStr, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
            ...
            sb.append(activity.getString(R.string.IPP_info_user) + ": ")
                ...
                .append(oldVersionStr, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
                .append('\n')
                ...
                .append('\n')
                .append(activity.getString(R.string.IPP_info_sdk) + ": ")
                .append(oldSdkStr, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
                .append(" ➞ ")
